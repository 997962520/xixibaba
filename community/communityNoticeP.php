...
<div class="subbox">
    ...
    <div class="left180">
        ...
        <ul class="menu1">
            ...
            <div class="menubox">
                ...
                <p><a href="communityMembers.php?id=<?php echo $rs['id'] ?>" >社区成员</a></p>
            </div>
        </ul>
    ...
    <div class="right840">
        ...
        <div class="display">
            <div class="wtnotice">
                <h1>社区最新公告</h1>
                <h2><?php echo $rs['notice'] ?></h2>
            </div>
            <table width="840" height="295" align="center" cellspacing="0" cellpadding="0" class="tab">
                <tr>
                    <td><font class="f_red">*</font>&nbsp;&nbsp;&nbsp;<b>发布公告:</b></td>
                    <td>&nbsp;&nbsp;&nbsp;
                        <textarea name="notice" class="input4" style="width:610px; height:170px;"></textarea></td>
                </tr>
                <tr>
                    <td></td>
                    <td colspan="2">&nbsp;&nbsp;&nbsp;
                        <input type="submit" value="提交信息" class="btn1" name="submit" />
                        &nbsp;&nbsp;&nbsp;
